...
`git clone https://github.com/visionify/carton-tracking.git`

2. Make sure that you fulfill all the requirements: Python 3.8 or later with all [requirements.txt], including torch>=1.7. To install, run:
